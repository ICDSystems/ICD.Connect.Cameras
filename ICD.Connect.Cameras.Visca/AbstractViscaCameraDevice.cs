...
namespace ICD.Connect.Cameras.Visca
{
		...
		where TSettings : IViscaCameraDeviceSettings, new()
	{
		...
		protected ISerialQueue SerialQueue { get { return m_SerialQueue; } }
		...
		/// Constructor.
		/// </summary>
		protected AbstractViscaCameraDevice()
		{
		...
		protected virtual void SendCommand(ViscaCommand command)
		{
		...
		protected virtual void SerialQueueOnSerialResponse(object sender, SerialResponseEventArgs args)
		{
			if (args.Data == null)
				return;
		...
		protected void HandleSuccess(ViscaCommand request, string response, eViscaResponse code)
		{
		...
		/// <param name="response"></param>
		protected void HandleError(ViscaCommand data, eViscaResponse response)
		{
		...
		protected override void AddControls(TSettings settings, IDeviceFactory factory,
		                                    Action<IDeviceControl> addControl)
		{
			base.AddControls(settings, factory, addControl);

			addControl(new GenericCameraRouteSourceControl<IViscaCameraDevice>(this, 0));
