...
{
	public sealed class VoIpTransmitLine : AbstractAttributeChild<VoIpTransmitBlock>, IVolumeAttributeInterface
	{
		...
		public VoIpTransmitLine(VoIpTransmitBlock parent, int index)
			: base(parent, index)
		{
