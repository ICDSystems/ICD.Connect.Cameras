...
{
	public interface ISettingsDevicePropertiesView : IView
	{
		/// <summary>
		...
		/// <returns></returns>
		IEnumerable<ISettingsDevicePropertiesComponentView> GetChildComponentViews(IViewFactory factory, ushort count);
	}
}
