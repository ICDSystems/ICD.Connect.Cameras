...
{
	public sealed class DialNavContactsComponentPresenter : AbstractDialNavComponentPresenter<IDirectoryPresenter>,
	                                                        IDialNavContactsComponentPresenter
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public DialNavContactsComponentPresenter(int room, INavigationController nav, IViewFactory views,
		                                         ICore core)
		...
		{
			return GetView().GetIcon(eDialNavIcon.Contacts);
		}
	}
}
