...
{
	public sealed class KeyboardAlphaPresenter : AbstractPresenter<IKeyboardAlphaView>, IKeyboardAlphaPresenter
	{
		...
		public KeyboardAlphaPresenter(int room, INavigationController nav, IViewFactory views, ICore core)
		...
		protected override void Refresh(IKeyboardAlphaView view)
		{
			base.Refresh(view);
		...
		/// </summary>
		/// <param name="view"></param>
		protected override void Subscribe(IKeyboardAlphaView view)
		{
			base.Subscribe(view);
		...
		/// </summary>
		/// <param name="view"></param>
		protected override void Unsubscribe(IKeyboardAlphaView view)
		{
		...
		{
			ShowView(false);
			Navigation.NavigateTo<IKeyboardSpecialPresenter>();
		}
