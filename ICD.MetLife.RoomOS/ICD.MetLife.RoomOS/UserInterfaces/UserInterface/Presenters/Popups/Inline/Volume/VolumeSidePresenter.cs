...
{
	public sealed class VolumeSidePresenter : AbstractPresenter<IVolumeSideView>, IVolumeSidePresenter
	{
		...
		public VolumeSidePresenter(int room, INavigationController nav, IViewFactory views, ICore core)
		...
		protected override void Refresh(IVolumeSideView view)
		{
			base.Refresh(view);
		...
		/// </summary>
		/// <param name="view"></param>
		protected override void Subscribe(IVolumeSideView view)
		{
			base.Subscribe(view);
		...
		/// </summary>
		/// <param name="view"></param>
		protected override void Unsubscribe(IVolumeSideView view)
		{
