...
{
	public sealed class MainNavMeetingsComponentPresenter : AbstractMainNavMenuComponentPresenter<IMeetingsPresenter>,
	                                                        IMainNavMeetingsComponentPresenter
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public MainNavMeetingsComponentPresenter(int room, INavigationController nav, IViewFactory views,
		                                         ICore core)
		...
		{
			return GetView().GetIcon(eMainNavIcon.Meetings);
		}
	}
}
