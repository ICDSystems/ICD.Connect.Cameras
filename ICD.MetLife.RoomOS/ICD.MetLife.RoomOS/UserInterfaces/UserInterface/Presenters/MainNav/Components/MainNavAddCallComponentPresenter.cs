...
{
	public sealed class MainNavAddCallComponentPresenter : AbstractMainNavMenuComponentPresenter<IDialpadPresenter>,
	                                                       IMainNavAddCallComponentPresenter
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public MainNavAddCallComponentPresenter(int room, INavigationController nav, IViewFactory views,
		                                        ICore core)
		...
		{
			return GetView().GetIcon(eMainNavIcon.AddCall);
		}
