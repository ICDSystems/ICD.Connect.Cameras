...
{
	public sealed class MainNavDialComponentPresenter : AbstractMainNavMenuComponentPresenter<IDialpadPresenter>,
	                                                    IMainNavDialComponentPresenter
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public MainNavDialComponentPresenter(int room, INavigationController nav, IViewFactory views, ICore core)
		...
		{
			return GetView().GetIcon(eMainNavIcon.Dial);
		}
