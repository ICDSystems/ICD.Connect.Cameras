...
{
	public sealed partial class SettingsDevicePropertiesView : AbstractView, ISettingsDevicePropertiesView
	{
		public event EventHandler OnExitButtonPressed;

		private readonly List<ISettingsDevicePropertiesComponentView> m_ChildList;

		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="panel"></param>
		public SettingsDevicePropertiesView(ISigInputOutput panel)
			: base(panel)
		{
			m_ChildList = new List<ISettingsDevicePropertiesComponentView>();
		}
		...
		/// <returns></returns>
		public IEnumerable<ISettingsDevicePropertiesComponentView> GetChildComponentViews(IViewFactory factory, ushort count)
		{
			return GetChildViews(factory, m_PropertyList, m_ChildList, count);
		}
