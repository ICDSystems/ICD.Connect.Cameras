...
namespace ICD.MetLife.RoomOS.UserInterfaces.UserInterface.IPresenters.VisibilityTree
{
	...
	public sealed class DefaultVisibilityNode : AbstractVisibilityNode
	{
		...
		public DefaultVisibilityNode(IPresenter defaultPresenter, IEnumerable<IPresenter> presenters)
			: base(presenters)
		{
			m_DefaultPresenter = defaultPresenter;
			AddPresenter(m_DefaultPresenter);
		...
		public DefaultVisibilityNode(IPresenter defaultPresenter, IEnumerable<IVisibilityNode> nodes)
			: base(nodes)
		{
			m_DefaultPresenter = defaultPresenter;
			AddPresenter(m_DefaultPresenter);
		...
		/// <param name="nodes"></param>
		public DefaultVisibilityNode(IPresenter defaultPresenter, IEnumerable<IPresenter> presenters,
		                             IEnumerable<IVisibilityNode> nodes)
