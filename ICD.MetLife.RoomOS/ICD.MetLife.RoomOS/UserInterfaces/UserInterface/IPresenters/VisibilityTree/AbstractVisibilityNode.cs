...
namespace ICD.MetLife.RoomOS.UserInterfaces.UserInterface.IPresenters.VisibilityTree
{
	...
	public abstract class AbstractVisibilityNode : IVisibilityNode
	{
		...
		/// Constructor.
		/// </summary>
		protected AbstractVisibilityNode() : this(null, null)
		{
		}
		...
		protected AbstractVisibilityNode(IEnumerable<IPresenter> presenters)
		...
		protected AbstractVisibilityNode(IEnumerable<IVisibilityNode> nodes)
			: this(null, nodes)
		{
		}
		...
		/// <param name="presenters"></param>
		/// <param name="nodes"></param>
		protected AbstractVisibilityNode(IEnumerable<IPresenter> presenters, IEnumerable<IVisibilityNode> nodes)
		{
