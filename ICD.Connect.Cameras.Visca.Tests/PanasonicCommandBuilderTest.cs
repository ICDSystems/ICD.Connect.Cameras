...
namespace ICD.Connect.Cameras.Panasonic.Tests_NetStandard
{
	...
	public sealed class PanasonicCommandBuilderTest
	{
		...
		{
			string result = PanasonicCommandBuilder.PowerOn();
			Assert.AreEqual("cgi-bin/aw_ptz?cmd=%23O1&res=1", result);
		}

		[Test]
		public void PowerOffTest()
		{
			string result = PanasonicCommandBuilder.PowerOff();
			Assert.AreEqual("cgi-bin/aw_ptz?cmd=%23O0&res=1", result);
		}
		...
		public void MoveTest(eCameraAction action, string expected)
		{
